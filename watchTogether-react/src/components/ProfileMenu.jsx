      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-[#181828] rounded-lg shadow-lg border border-[#232346] py-2 z-50">
          ...
          <div className="py-1">
            ...
            <button className="w-full text-left px-4 py-2 text-gray-300 hover:bg-[#232346] hover:text-white transition-colors flex items-center space-x-3 cursor-pointer">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
